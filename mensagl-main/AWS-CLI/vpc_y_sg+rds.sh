...
# Instalar WordPress
sudo -u ubuntu wp core install --url=http://${PRIVATE_IP} --title="Mi WordPress" --admin_user=${DB_USERNAME} --admin_password=${DB_PASSWORD} --admin_email="dsantamarias01@educantabria.es" --path=/var/www/html
...
# sudo -u ubuntu -k -- wp core install --url=10.228.4.100  --title=Site_Title --admin_user=${DB_USERNAME} --admin_password=${DB_PASSWORD} --admin_email=majam02@educantabria.es --path=/var/www/html
# #sudo -u ubuntu -k -- wp option update home 'http://10.228.4.10' --path=/var/www/html
# #sudo -u ubuntu -k -- wp option update siteurl 'http://10.228.4.10' --path=/var/www/html
